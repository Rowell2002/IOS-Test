...
#ifndef IOS_DEV_SWIFT_H
#define IOS_DEV_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IOS_Dev",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC7IOS_Dev15LocationManager")
